    ...
    var laliga = [3, 4, 5, 6];
    var outcomeValues = [
        { outcome: "Home (1)", odds: "1.90", league: 1 },
        { outcome: "Draw (X)", odds: "3.10", league: 1 },
        { outcome: "Away (2)", odds: "2.50", league: 1 },
        { outcome: "Over 2.5 goals", odds: "2.10", league: 2 },
        { outcome: "Over 3.5 goals", odds: "3.10", league: 2 },
        { outcome: "Over 4.5 goals", odds: "4.10", league: 2 },
        { outcome: "Over 5.5 goals", odds: "6.10", league: 2 }
/*      { outcome: "Both teams to score - Yes", odds: "1.63" },
    ...
    $("#test").click(function(){
        outcomeList.filter(function(item) {
            if (array.indexOf((item.values().league)) >= 0)  {
                return true;
            } else {
                return false;
            }
